...
Original file is located at
    https://colab.research.google.com/drive/1dUePjbwTw4f2FV_t0MQ-LdzyA7r8Kjg6
"""
...
def main():
    ...
    # logic to replace the word python with pythons
...
def main():
    try:
        ...
        # writing if else conditions based on the grading scale
        if class_score >= 90:
            letter_grade = 'A'
        elif class_score >= 80:
            letter_grade = 'B'
